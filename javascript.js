...
function buildGrids(howMany) {
    for (i = 0; i < howMany*howMany; i++) {
        ...
        pixel.setAttribute(`style`, `height: ${500/howMany}px; width: ${500/howMany}px; border: 1px solid black; box-sizing: border-box; opacity: 0.1;`)
        ...
        pixel.addEventListener("mouseover", () => {
            ...
            newOpacity = +pixel.style.opacity + 0.1;
